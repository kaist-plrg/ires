...
object `AL::IdentifierReference[0,0].EarlyErrors` extends Algo {
  val head = SyntaxDirectedHead("IdentifierReference", 0, 0, Rhs(List(NonTerminal("Identifier", List(""), false)), None), "EarlyErrors", List())
  val ids = List(
