...
object `AL::GLOBAL.Array.prototype.forEach` extends Algo {
  val head = BuiltinHead(parseRef("""Array.prototype.forEach"""), List(Param("callbackfn", Normal), Param("thisArg", Optional)))
  val ids = List(
