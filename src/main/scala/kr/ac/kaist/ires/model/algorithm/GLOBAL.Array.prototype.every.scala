...
object `AL::GLOBAL.Array.prototype.every` extends Algo {
  val head = BuiltinHead(parseRef("""Array.prototype.every"""), List(Param("callbackfn", Normal), Param("thisArg", Optional)))
  val ids = List(
