...
object `AL::LabelledItem[0,0].TopLevelVarDeclaredNames` extends Algo {
  val head = SyntaxDirectedHead("LabelledItem", 0, 0, Rhs(List(NonTerminal("Statement", List(""), false)), None), "TopLevelVarDeclaredNames", List())
  val ids = List(
