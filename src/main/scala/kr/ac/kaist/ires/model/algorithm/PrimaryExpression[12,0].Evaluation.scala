...
object `AL::PrimaryExpression[12,0].Evaluation` extends Algo {
  val head = SyntaxDirectedHead("PrimaryExpression", 12, 0, Rhs(List(NonTerminal("CoverParenthesizedExpressionAndArrowParameterList", List(""), false)), None), "Evaluation", List())
  val ids = List(
  ...
  |  0:let expr = __x0__
  |  1:access __x1__ = (expr "Evaluation")
  |  1:return __x1__
  |}""".stripMargin)
