...
object `AL::RelationalExpression[2,0].Evaluation` extends Algo {
  val head = SyntaxDirectedHead("RelationalExpression", 2, 0, Rhs(List(NonTerminal("RelationalExpression", List(""), false), Terminal(">"), NonTerminal("ShiftExpression", List(""), false)), None), "Evaluation", List())
  val ids = List(
