...
object `AL::IteratorClose` extends Algo {
  val head = NormalHead("IteratorClose", List(Param("iteratorRecord", Normal), Param("completion", Normal)))
  val ids = List(
    "sec-iteratorclose",
  ...
  |  10:if (! (= (typeof innerResult.Value) Object)) throw TypeError else 1:{}
