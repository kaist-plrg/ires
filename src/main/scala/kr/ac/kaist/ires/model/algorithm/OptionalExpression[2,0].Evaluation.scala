...
object `AL::OptionalExpression[2,0].Evaluation` extends Algo {
  val head = SyntaxDirectedHead("OptionalExpression", 2, 0, Rhs(List(NonTerminal("OptionalExpression", List(""), false), NonTerminal("OptionalChain", List(""), false)), None), "Evaluation", List())
  val ids = List(
  ...
  |  0:access __x0__ = (OptionalExpression "Evaluation")
