...
object `AL::IdentifierName[0,0].StringValue` extends Algo {
  val head = SyntaxDirectedHead("IdentifierName", 0, 0, Rhs(List(NonTerminal("IdentifierStart", List(""), false)), None), "StringValue", List())
  val ids = List(
