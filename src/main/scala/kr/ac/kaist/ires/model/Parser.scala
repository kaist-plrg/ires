...
object Parser extends ESParsers {
  ...
  lazy val AssignmentExpression: ESParser[AssignmentExpression] = memo(args => {
    ...
    log((
      ...
      log((MATCH ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("&&=")) ~ AssignmentExpression(List(pIn, pYield, pAwait)) ^^ { case _ ~ x0 ~ x1 => AssignmentExpression6(x0, x1, args) })("AssignmentExpression6") |
      log((MATCH ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("||=")) ~ AssignmentExpression(List(pIn, pYield, pAwait)) ^^ { case _ ~ x0 ~ x1 => AssignmentExpression7(x0, x1, args) })("AssignmentExpression7") |
      log((MATCH ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("??=")) ~ AssignmentExpression(List(pIn, pYield, pAwait)) ^^ { case _ ~ x0 ~ x1 => AssignmentExpression8(x0, x1, args) })("AssignmentExpression8")
  ...
  lazy val IterationStatement: ESParser[IterationStatement] = memo(args => {
    ...
    log((
      log(MATCH ~ DoWhileStatement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 => IterationStatement0(x0, args) })("IterationStatement0") |
      log(MATCH ~ WhileStatement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 => IterationStatement1(x0, args) })("IterationStatement1") |
      log(MATCH ~ ForStatement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 => IterationStatement2(x0, args) })("IterationStatement2") |
      log(MATCH ~ ForInOfStatement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 => IterationStatement3(x0, args) })("IterationStatement3")
    ))("IterationStatement")
  })
  lazy val DoWhileStatement: ESParser[DoWhileStatement] = memo(args => {
    ...
    log((
      log((((((MATCH <~ t("do")) ~ Statement(List(pYield, pAwait, pReturn)) <~ t("while")) <~ t("(")) ~ Expression(List(true, pYield, pAwait)) <~ t(")")) <~ t(";")) ^^ { case _ ~ x0 ~ x1 => DoWhileStatement0(x0, x1, args) })("DoWhileStatement0")
    ))("DoWhileStatement")
  })
  lazy val WhileStatement: ESParser[WhileStatement] = memo(args => {
    val List(pYield, pAwait, pReturn) = getArgsN("WhileStatement", args, 3)
    log((
      log((((MATCH <~ t("while")) <~ t("(")) ~ Expression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 => WhileStatement0(x0, x1, args) })("WhileStatement0")
    ))("WhileStatement")
  })
  lazy val ForStatement: ESParser[ForStatement] = memo(args => {
    val List(pYield, pAwait, pReturn) = getArgsN("ForStatement", args, 3)
    log((
      log(((((((MATCH <~ t("for")) <~ t("(")) <~ -ntl((("let" <~ not(IDContinue)) %% "["))) ~ opt(Expression(List(false, pYield, pAwait))) <~ t(";")) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(";")) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 ~ x3 => ForStatement0(x0, x1, x2, x3, args) })("ForStatement0") |
      log(((((((MATCH <~ t("for")) <~ t("(")) <~ t("var")) ~ VariableDeclarationList(List(false, pYield, pAwait)) <~ t(";")) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(";")) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 ~ x3 => ForStatement1(x0, x1, x2, x3, args) })("ForStatement1") |
      log(((((MATCH <~ t("for")) <~ t("(")) ~ LexicalDeclaration(List(false, pYield, pAwait)) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(";")) ~ opt(Expression(List(true, pYield, pAwait))) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 ~ x3 => ForStatement2(x0, x1, x2, x3, args) })("ForStatement2")
    ))("ForStatement")
  })
  lazy val ForInOfStatement: ESParser[ForInOfStatement] = memo(args => {
    ...
    log((
      log((((((MATCH <~ t("for")) <~ t("(")) <~ -ntl((("let" <~ not(IDContinue)) %% "["))) ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("in")) ~ Expression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement0(x0, x1, x2, args) })("ForInOfStatement0") |
      log((((((MATCH <~ t("for")) <~ t("(")) <~ t("var")) ~ ForBinding(List(pYield, pAwait)) <~ t("in")) ~ Expression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement1(x0, x1, x2, args) })("ForInOfStatement1") |
      log(((((MATCH <~ t("for")) <~ t("(")) ~ ForDeclaration(List(pYield, pAwait)) <~ t("in")) ~ Expression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement2(x0, x1, x2, args) })("ForInOfStatement2") |
      log((((((MATCH <~ t("for")) <~ t("(")) <~ -ntl((("let" <~ not(IDContinue))) | (("async" <~ not(IDContinue)) %% ("of" <~ not(IDContinue))))) ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement3(x0, x1, x2, args) })("ForInOfStatement3") |
      log((((((MATCH <~ t("for")) <~ t("(")) <~ t("var")) ~ ForBinding(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement4(x0, x1, x2, args) })("ForInOfStatement4") |
      log(((((MATCH <~ t("for")) <~ t("(")) ~ ForDeclaration(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement5(x0, x1, x2, args) })("ForInOfStatement5") |
      log((if (pAwait) ((((((MATCH <~ t("for")) <~ t("await")) <~ t("(")) <~ -ntl((("let" <~ not(IDContinue))))) ~ LeftHandSideExpression(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement6(x0, x1, x2, args) } else MISMATCH))("ForInOfStatement6") |
      log((if (pAwait) ((((((MATCH <~ t("for")) <~ t("await")) <~ t("(")) <~ t("var")) ~ ForBinding(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement7(x0, x1, x2, args) } else MISMATCH))("ForInOfStatement7") |
      log((if (pAwait) (((((MATCH <~ t("for")) <~ t("await")) <~ t("(")) ~ ForDeclaration(List(pYield, pAwait)) <~ t("of")) ~ AssignmentExpression(List(true, pYield, pAwait)) <~ t(")")) ~ Statement(List(pYield, pAwait, pReturn)) ^^ { case _ ~ x0 ~ x1 ~ x2 => ForInOfStatement8(x0, x1, x2, args) } else MISMATCH))("ForInOfStatement8")
    ))("ForInOfStatement")
  })
  ...
  lazy val AsyncFunctionExpression: ESParser[AsyncFunctionExpression] = memo(args => {
    log((
      log((((((((MATCH <~ t("async")) <~ NoLineTerminator) <~ t("function")) ~ opt(BindingIdentifier(List(false, true))) <~ t("(")) ~ FormalParameters(List(false, true)) <~ t(")")) <~ t("{")) ~ AsyncFunctionBody(List()) <~ t("}")) ^^ { case _ ~ x0 ~ x1 ~ x2 => AsyncFunctionExpression0(x0, x1, x2, args) })("AsyncFunctionExpression0")
