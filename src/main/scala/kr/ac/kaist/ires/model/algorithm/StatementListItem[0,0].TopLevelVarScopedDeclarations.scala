...
object `AL::StatementListItem[0,0].TopLevelVarScopedDeclarations` extends Algo {
  val head = SyntaxDirectedHead("StatementListItem", 0, 0, Rhs(List(NonTerminal("Statement", List(""), false)), None), "TopLevelVarScopedDeclarations", List())
  val ids = List(
