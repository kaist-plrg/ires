...
object `AL::ExportDeclaration[3,0].ExportEntries` extends Algo {
  val head = SyntaxDirectedHead("ExportDeclaration", 3, 0, Rhs(List(Terminal("export"), NonTerminal("Declaration", List(""), false)), None), "ExportEntries", List())
  val ids = List(
  ...
  |  0:let entries = (new [])
  |  1:access __x0__ = (Declaration "BoundNames")
  |  1:let names = __x0__
  |  2:let __x1__ = names
  |  2:let __x2__ = 0i
