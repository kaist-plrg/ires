...
object `AL::StatementList[1,0].LexicallyScopedDeclarations` extends Algo {
  val head = SyntaxDirectedHead("StatementList", 1, 0, Rhs(List(NonTerminal("StatementList", List(""), false), NonTerminal("StatementListItem", List(""), false)), None), "LexicallyScopedDeclarations", List())
  val ids = List(
  ...
  |  1:access __x1__ = (StatementListItem "LexicallyScopedDeclarations")
  |  1:let __x2__ = __x1__
  |  1:let __x3__ = 0i
