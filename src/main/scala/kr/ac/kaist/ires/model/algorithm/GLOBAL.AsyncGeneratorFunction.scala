...
object `AL::GLOBAL.AsyncGeneratorFunction` extends Algo {
  val head = BuiltinHead(parseRef("""AsyncGeneratorFunction"""), List())
  val ids = List(
  ...
  |  2:app __x0__ = (CreateDynamicFunction C NewTarget CONST_asyncGenerator args)
  |  2:return [? __x0__]
  |}""".stripMargin)
