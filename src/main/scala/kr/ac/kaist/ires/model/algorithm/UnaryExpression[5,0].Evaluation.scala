...
object `AL::UnaryExpression[5,0].Evaluation` extends Algo {
  val head = SyntaxDirectedHead("UnaryExpression", 5, 0, Rhs(List(Terminal("-"), NonTerminal("UnaryExpression", List(""), false)), None), "Evaluation", List())
  val ids = List(
