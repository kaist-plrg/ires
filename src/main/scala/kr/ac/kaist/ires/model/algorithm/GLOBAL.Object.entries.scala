...
object `AL::GLOBAL.Object.entries` extends Algo {
  val head = BuiltinHead(parseRef("""Object.entries"""), List(Param("O", Normal)))
  val ids = List(
    "sec-object.entries",
  ...
  |  0:let obj = [? __x0__]
  |  1:app __x1__ = (EnumerableOwnPropertyNames obj CONST_keyPLUSvalue)
