...
object `AL::GLOBAL.WeakSet.prototype.add` extends Algo {
  val head = BuiltinHead(parseRef("""WeakSet.prototype.add"""), List(Param("value", Normal)))
  val ids = List(
  ...
  |  1:[? __x0__]
  |  2:if (! (= (typeof value) Object)) throw TypeError else 15:{}
