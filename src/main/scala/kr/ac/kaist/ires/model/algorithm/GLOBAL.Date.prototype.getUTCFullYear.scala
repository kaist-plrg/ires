...
object `AL::GLOBAL.Date.prototype.getUTCFullYear` extends Algo {
  val head = BuiltinHead(parseRef("""Date.prototype.getUTCFullYear"""), List())
  val ids = List(
