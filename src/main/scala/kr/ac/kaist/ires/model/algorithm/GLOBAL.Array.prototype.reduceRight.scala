...
object `AL::GLOBAL.Array.prototype.reduceRight` extends Algo {
  val head = BuiltinHead(parseRef("""Array.prototype.reduceRight"""), List(Param("callbackfn", Normal), Param("initialValue", Optional)))
  val ids = List(
