...
object `AL::GLOBAL.Array.prototype.findIndex` extends Algo {
  val head = BuiltinHead(parseRef("""Array.prototype.findIndex"""), List(Param("predicate", Normal), Param("thisArg", Optional)))
  val ids = List(
