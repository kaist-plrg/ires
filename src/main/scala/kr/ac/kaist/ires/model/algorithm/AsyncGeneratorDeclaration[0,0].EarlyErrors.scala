...
object `AL::AsyncGeneratorDeclaration[0,0].EarlyErrors` extends Algo {
  val head = SyntaxDirectedHead("AsyncGeneratorDeclaration", 0, 0, Rhs(List(Terminal("async"), Terminal("function"), Terminal("*"), NonTerminal("BindingIdentifier", List(""), false), Terminal("("), NonTerminal("FormalParameters", List(""), false), Terminal(")"), Terminal("{"), NonTerminal("AsyncGeneratorBody", List(""), false), Terminal("}")), None), "EarlyErrors", List())
  val ids = List(
  ...
  |  } else 2:{}
  |  2:let __x1__ = true
  |  2:access __x2__ = (AsyncGeneratorBody "FunctionBodyContainsUseStrict")
  ...
  |  3:access __x5__ = (AsyncGeneratorBody "LexicallyDeclaredNames")
  |  3:let __x6__ = __x4__
  |  3:let __x7__ = __x5__
  |  3:let __x8__ = 0i
  |  3:let __x9__ = 0i
  ...
  |  5:access __x12__ = (FormalParameters "Contains" "AwaitExpression")
  |  5:if (= __x12__ true) throw SyntaxError else 2:{}
  |  6:access __x13__ = (FormalParameters "Contains" "SuperProperty")
  |  6:if (= __x13__ true) throw SyntaxError else 2:{}
  |  7:access __x14__ = (AsyncGeneratorBody "Contains" "SuperProperty")
  |  7:if (= __x14__ true) throw SyntaxError else 2:{}
  |  8:access __x15__ = (FormalParameters "Contains" "SuperCall")
  |  8:if (= __x15__ true) throw SyntaxError else 2:{}
  |  9:access __x16__ = (AsyncGeneratorBody "Contains" "SuperCall")
  |  9:if (= __x16__ true) throw SyntaxError else 2:{}
  |}""".stripMargin)
