...
object `AL::AsyncGeneratorMethod[0,0].MethodDefinitionEvaluation` extends Algo {
  val head = SyntaxDirectedHead("AsyncGeneratorMethod", 0, 0, Rhs(List(Terminal("async"), Terminal("*"), NonTerminal("PropertyName", List(""), false), Terminal("("), NonTerminal("UniqueFormalParameters", List(""), false), Terminal(")"), Terminal("{"), NonTerminal("AsyncGeneratorBody", List(""), false), Terminal("}")), None), "MethodDefinitionEvaluation", List(Param("object", Normal), Param("enumerable", Normal)))
  val ids = List(
  ...
  |  4:app __x1__ = (OrdinaryFunctionCreate INTRINSIC_AsyncGeneratorFunction_prototype sourceText UniqueFormalParameters AsyncGeneratorBody CONST_nonDASHlexicalDASHthis scope)
  |  4:let closure = [! __x1__]
  |  5:app __x2__ = (MakeMethod closure object)
  |  5:[! __x2__]
  |  6:app __x3__ = (SetFunctionName closure propKey)
  |  6:[! __x3__]
  |  7:app __x4__ = (OrdinaryObjectCreate INTRINSIC_AsyncGeneratorFunction_prototype_prototype)
